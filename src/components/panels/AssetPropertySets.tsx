...
const IFC_APPLIANCE_OPTIONS: { value: IfcElectricApplianceTypeEnum | ''; label: string }[] = [
  ...
  { value: 'REFRIGERATOR', label: '❄️ Kühlschrank' },
  { value: 'FREEZER', label: '🧊 Tiefkühler' },
  { value: 'FRIDGE_FREEZER', label: '❄️🧊 Kühl-Gefrierkombination' },
  { value: 'MICROWAVE', label: '📡 Mikrowelle' },
  { value: 'ELECTRICCOOKER', label: '🍳 Elektroherd' },
  { value: 'DISHWASHER', label: '🍽️ Geschirrspüler' },
  ...
  { value: 'RADIANTHEATER', label: '☀️ Strahlungsheizung' },
...
const COFFEE_EQUIPMENT_OPTIONS: { value: CoffeeEquipmentType | ''; label: string }[] = [
  ...
  { value: 'COFFEEGRINDER', label: '⚙️ Kaffeemühle' },
  ...
  { value: 'DISPLAYCASE', label: '🗄️ Vitrine/Auslage' },
